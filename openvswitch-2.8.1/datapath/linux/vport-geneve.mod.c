...
__attribute__((section("__versions"))) = {
	...
	{ 0x71695443, __VMLINUX_SYMBOL_STR(ovs_geneve_fill_metadata_dst) },
	{ 0xd3786a9b, __VMLINUX_SYMBOL_STR(rpl_geneve_xmit) },
	...
	{ 0x10b5f634, __VMLINUX_SYMBOL_STR(rpl_geneve_dev_create_fb) },
...
MODULE_INFO(srcversion, "B5C5A6BAB185639986B2693");
