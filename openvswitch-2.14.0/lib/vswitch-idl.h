...
{
    return ovsrec_ct_timeout_policy_row_get_seqno(row, OVSDB_IDL_CHANGE_MODIFY) == 0;
}
...
{
    return ovsrec_ct_zone_row_get_seqno(row, OVSDB_IDL_CHANGE_MODIFY) == 0;
}
...
{
    return ovsrec_datapath_row_get_seqno(row, OVSDB_IDL_CHANGE_MODIFY) == 0;
}
