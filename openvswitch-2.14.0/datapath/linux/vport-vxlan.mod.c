...
__attribute__((section("__versions"))) = {
	...
	{ 0x2df16850, __VMLINUX_SYMBOL_STR(ovs_vxlan_fill_metadata_dst) },
	{ 0x373dba54, __VMLINUX_SYMBOL_STR(rpl_vxlan_xmit) },
	...
	{ 0x94d67553, __VMLINUX_SYMBOL_STR(rpl_vxlan_dev_create) },
...
MODULE_INFO(srcversion, "C3A7121CC7A201582425689");
