...
__attribute__((section("__versions"))) = {
	...
	{ 0x86a8b120, __VMLINUX_SYMBOL_STR(ovs_stt_fill_metadata_dst) },
	{ 0xbb249ca9, __VMLINUX_SYMBOL_STR(ovs_stt_xmit) },
	...
	{ 0x598be197, __VMLINUX_SYMBOL_STR(ovs_stt_dev_create_fb) },
...
MODULE_INFO(srcversion, "217A18A5683B09408AA2E73");
