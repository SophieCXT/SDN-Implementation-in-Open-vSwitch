...
__attribute__((section("__versions"))) = {
	...
	{ 0xbb871c86, __VMLINUX_SYMBOL_STR(ovs_lisp_fill_metadata_dst) },
	{ 0x1d566842, __VMLINUX_SYMBOL_STR(rpl_lisp_xmit) },
	...
	{ 0x63686107, __VMLINUX_SYMBOL_STR(rpl_lisp_dev_create_fb) },
...
MODULE_INFO(srcversion, "B6C22F6BF4511DC55866A2C");
